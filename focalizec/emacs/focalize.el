  ...
  (concat "\\<"
    (regexp-opt
     '("alias" "all" "and" "as" "assume" "assumed" "begin" "by"
       "caml" "collection" "conclude" "coq" "coq_require" "dedukti"
       "coq_require" "definition" "else" "end" "ex" "external" "false" "final"
       "function" "hypothesis" "if" "in" "inherit" "internal" "implement" "is"
       "let" "lexicographic" "local" "logical" "match" "measure" "not"

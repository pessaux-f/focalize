% $Id: proofs.tex,v 1.16 2009-03-13 13:58:25 doligez Exp $
...
\alt \tok{by} \reps{\nt{fact}}
\alt \tok{conclude}
\alt \tok{coq~proof} \nt{enforced\_dependencies} \nt{external\_code}
\alt \nt{enforced\_dependencies} \tok{assumed} \nt{external\_code}
\end{syn}
...
\begin{syn}
\nt{qed\_step} \is
    \nt{proof\_step\_bullet} \tok{ qed} \nt{proof}
\alt\nt{proof\_step\_bullet} \tok{ conclude}
\end{syn}

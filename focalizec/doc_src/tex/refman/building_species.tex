% $Id: building_species.tex,v 1.9 2008-12-16 17:32:00 hardin Exp $
...
\noindent{\bf Species inheriting species parameterised by {\tt Self}} 
...
In this cases, knowing the type (or the logical statement) of the used methods is sufficient to

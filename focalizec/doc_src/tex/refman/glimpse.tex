% $Id: glimpse.tex,v 1.8 2009-06-04 15:11:07 jaeger Exp $
...
\begin{itemize}
  \item The %{\em method} introduced by the keyword [EJ] J'essaye d'alleger
...
must be eliminated to obtain runnable code. % [EJ] Cette explication est-elle utile ici ?
...
confuse a species and its interface. % [EJ] Pas super clair...
...
{\tt inherits} clause serves to determine the chosen {\em method} (only the latest definition of any method appearing several times in the list of inherited species is retained).
...
\zenon \cite{Zenon,zenon0.4.1} developed by D. Doligez. This prover is % [EJ] Reference incorrecte

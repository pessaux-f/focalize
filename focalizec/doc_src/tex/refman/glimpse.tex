% $Id: glimpse.tex,v 1.1 2008-12-11 10:48:24 hardin Exp $
\def\bbbn{{\rm I\!N}} 
\label{glimpse}
...
\subsection{Type of Species, Interfaces and Collections}
\label{species-type}
...
\subsection{Combining Bricks by Inheritance}
...
\subsection{Combining Bricks by Parameterisation}
...
\subsubsection{Parameterisation by Collection Parameters}
...
\subsubsection{Parameterisation by Entity Parameters}
...
\subsection{{\em Properties}, {\em Theorems} and {\em Proofs}}
...
\subsection{Around the Language}
...
\subsubsection{Consistency of the Software}

...
\newcommand{\focal}{{\sf FoCaLize}}
\newcommand{\focalversion}{{\sf 1.0.0}}
\newcommand{\focalversiondate}{{\sf January 2009}}
\newcommand{\coq}{{\sf Coq}}
\newcommand{\cime}{{\sf CiME}}
\newcommand{\zenon}{{\sf Zenon}}
\newcommand{\focdoc}{{\sf FoCaLizeDoc}}
\newcommand{\dotty}{{\sf dotty}}
\newcommand{\graphviz}{{\sf graphviz}}
\newcommand{\emacs}{{\sf emacs}}
\newcommand{\cygwin}{{\sf Cygwin}}
\newcommand{\xsltproc}{{\sf xsltproc}}

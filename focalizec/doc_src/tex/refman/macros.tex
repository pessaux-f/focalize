\def\month{May}
\def\year{2023}
\def\focalizeversion{\sf 0.9.5}

\def\focalizeversiondate{\sf {\month} {\year}}
...
\def\coq{{\sf Coq}}
\def\dedukti{{\sf Dedukti}}
\def\sukerujo{{\sf Sukerujo}}
\def\cime{{\sf CiME}}
\def\zenon{{\sf Zenon}}
\def\zmod{{\sf Zenon Modulo}}
\def\zvtov{{\sf zvtov}}
...
\lstdefinelanguage{FoCaLiZe}
  {morekeywords={alias, all, and, as, assume, assumed, begin, by, caml,
      collection, coq, coq_require, dedukti, definition, else, end,
...
\newenvironment{compact-enumerate}{
\begin{enumerate}
     \setlength{\itemsep}{1pt}
     \setlength{\parskip}{0pt}
     \setlength{\parsep}{0pt}}

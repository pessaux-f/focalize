% $Id: lexical_conventions.tex,v 1.12 2009-01-28 18:10:20 weis Exp $
...
meaningful: "the table is green"; the same nonsense arises as well if you
...
Those concepts are compositional: these concepts are independent form one
...
complex combination of symbols. For instance, according to usual mathematical
conventions:
\begin{citemize}

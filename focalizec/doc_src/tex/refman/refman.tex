...
Raphaël Cauderliner (INRIA-LSV-CNAM),
...
Ivan Noyer (SPI-LIP6),
Fran\c{c}ois Pessaux (SPI-LIP6)(UIIS-ENSTA Paris), Virgile Prevosto (SPI-LIP6),
...
{\em
U2S (Unité d'Informatique et d'Ingénierie des Systèmes) is a team of
...
\subsection{Dealing with hand-written {\coq} and {\dedukti} proofs}
\label{coq-proofs}

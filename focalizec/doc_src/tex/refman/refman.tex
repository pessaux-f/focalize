% $Id: refman.tex,v 1.14 2008-10-28 10:09:28 pessaux Exp $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Species, collections names}
\index{species!name}
...
(double quote) characters (ipso facto with no intervening {\tt "}).
Escape sequences (meta code to insert characters that can't appears
simple in a string) available in string literals are summarised in the
table below:
...
\begin{tabular}{|c|c|l|}
  ...
  \hline
  $\setminus$n & '$\setminus$010' & Line feed character. \\
  \hline
  $\setminus$r & '$\setminus$013' & Carriage return character. \\
  \hline
  $\setminus$b & '$\setminus$008' & \\
  \hline
  $\setminus$t & '$\setminus$009' & Tabulation character \\
  \hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Floating-point numbers literals}



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Proof step bullets}
...
%%   --methods-history-to-text  dumps species' methods' inheritance history as plain text
...
%%   --no-coq-code  disables the Coq code generation.
%%   --no-ocaml-code  disables the OCaml code generation.
%%   -no-stdlib-path  does not include by default the standard library installation
%% 	directory in the search path.
%%   --pretty  pretty-prints the parse tree of the focal file as a focal source
%% 	 into the argument file.
%%   --raw-ast-dump  (undocumented) prints on stderr the raw AST structure after
%% 	parsing stage.
%%   --scoped_pretty  (undocumented) pretty-prints the parse tree of the focal file
...
%%   -v  prints the focalize version then exit.
%%   --version  prints the full focalize version, sub-version and release date,
%% 	then exit.
%%   --where  prints the binaries and libraries installation directories then exit.

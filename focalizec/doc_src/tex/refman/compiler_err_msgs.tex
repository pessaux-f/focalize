% $Id: compiler_err_msgs.tex,v 1.15 2008-12-11 10:48:24 hardin Exp $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Sum type constructor '$name$' expected $n_1$ arguments but
...
{\em Description}:  During collection parameter instantiation, the
interface of the 
provided collection  $s_1$ is not compatible with the interface $s_2$, because it doesn't have a signature containing at
...
{\em Description}: The \focal\ source file $file$.fcl was compiled but

...
lident & ::= & (lower | \_) \{ letter \mid digit \mid \_ \} & \\
uident & ::= & upper \{ letter \mid digit \mid \_ \} & \\
ident & ::= & lident | uident
\end{syntax}
\vspace{0.2cm}
...
\begin{itemize}
  ...
  \item {\bf Infix/prefix operators}.
    ...
    prefix\_op & ::= & prefix\_char
        \{ letter \mid prefix\_char \mid infix\_char \mid digit \mid \_ \}* & \\
...
binary\_digit & ::= & 0 \mid 1 & \\
octal\_digit & ::= & 0 \ldots 7 & \\
decimal\_digit & ::= & 0 \ldots 9 & \\
hexadecimal\_digit & ::= & 0 \ldots 9 \mid A \ldots F \mid a \ldots f & \\
sign & ::= & + \mid - & \\
unsigned\_binary\_literal & ::= &
  0 \{ b \mid B \}\ binary\_digit\ \{ binary\_digit \mid \_ \}* & \\
unsigned\_octal\_literal & ::= &
  0 \{ o \mid O \}\ octal\_digit\ \{ octal\_digit \mid \_ \}* & \\
unsigned\_decimal\_literal & ::= &
  decimal\_digit \{ decimal\_digit \mid \_ \} * & \\
unsigned\_hexadecimal\_literal & ::= &
  0 \{ x \mid X \}\ hexadecimal\_digit\ \{ hexadecimal\_digit \mid \_ \}* & \\
...
proof\_step\_bullet & ::= & < \{ 0 \ldots 9 \}+\ >\ letter+
\end{syntax}

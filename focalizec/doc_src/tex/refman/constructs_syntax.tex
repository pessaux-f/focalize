% $Id: constructs_syntax.tex,v 1.32 2008-12-18 15:04:32 hardin Exp $
...
expression. If $t_2$ is introduced by a top-level definition, then its
...
Two types  $t_1$ and  $t_2$  are said {\bf
  compatible}\index{type!compatible} if they have a common 
instanciation. 

% $Id: constructs_syntax.tex,v 1.44 2009-06-04 14:40:45 pessaux Exp $
...
basics#bool,  basics#int,  basics#string are not compatible.
\end{verbatim}
because {\tt Cstr2} expects 3 arguments (types separated by comma) and
{\tt mytuple} aliases a tuple.

\medskip
{\scriptsize
\begin{lstlisting}
let fct_t4(x) in mytuple =
  match x with
   | Cstr2 (a, b, c) -> (a, b, c)
;;
\end{lstlisting}
}
\noindent is accepted since we rebuild explicitly a tuple from the 3
arguments of {\tt Cstr2}.

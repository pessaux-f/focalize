...
The idea is that the ``{\tt in}'' expression is implicitely the
...
outside any species. This deals with general functions and genaral
...
the {\tt let} keyword and don't have a ``{\tt in}'' expression and
theorems are introduced by the {\tt theorem} keword. As already stated

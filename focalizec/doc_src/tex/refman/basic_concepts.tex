...
{\coq} and {\dedukti} code, since all the components are known.
...
species Full =
  rep = int ;
  let create_random : Self = random_foc#random_int (42) ;
  let double (x : Self) : Self = x + x ;
...
let v = MyFull_Instance!create_random ;;
MyFull_Instance!print (v) ;;
let dv = MyFull_Instance!double (v) ;;
MyFull_Instance!print (dv) ;;
\end{lstlisting}
}

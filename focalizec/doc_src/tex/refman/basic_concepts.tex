% $Id: basic_concepts.tex,v 1.11 2008-12-16 17:32:00 hardin Exp $
...
\item {\bf Signatures}\index{signature}. They introduce names of
  constants and functions, uniquely providing their type as a type expression. A signature
...
create entities of this collection. We print the result of the evaluation of
the top-level definitions of {\tt v} and {\tt dv}. 

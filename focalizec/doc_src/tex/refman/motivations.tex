% $Id: motivations.tex,v 1.5 2008-12-19 10:13:53 pessaux Exp $
...
Currently, \focal\  can be seen as an IDE still in development, which
...
(V. Prevosto thesis\cite{PrevostoPhD03,TPHOL2002,PrevostoJAR02}) and
the correction of the compiler (mostly written by V. Prevosto) against
\focal's semantics is proved (by hand) \cite{TLCA2005}, a point which

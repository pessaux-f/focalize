% $Id: intermediate.tex,v 1.8 2009-06-02 16:41:19 pessaux Exp $
...
really coming from parameters, forgetting those comming from other
...
carriers we depend on are computed, we simply stlow, in the ore them in a
...
rules [TYPE] and all the completion rules.

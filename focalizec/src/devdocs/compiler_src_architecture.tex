...
\item {\tt src} (d 1) : Root of the sources of \focalizec\ and \focalizedep.
  ...
  \item {\tt docgen} (d 2) : Source for \focalizec\ automated
    ...
    \end{itemize}
  \item {\tt extlib} (d 2) : \index{extra library}
    \index{library!extra}
  ...
  \item {\tt parser} (d 2) : Contains the lexical and syntactic
    ...
    \item {\tt lexer.mll} (f) : \index{lexer}
      The lexer description in \ocamllex.
    ...
    \item {\tt parser.mly} (f) : \index{parser}
      The parser description in \ocamlyacc.
  ...
  \item {\tt stdlib} (d 2) : \index{stdlib}
    \index{standard library} \index{library!standard}
    The standard library. Most of these
  ...
  \item {\tt toplevel} (d 2)
    ...
    \item {\tt focalizec.ml} (f) : \index{compiler entry point}
      \index{entry point}
    ...
    \end{itemize}
  \item {\tt typing} (d 2) : \index{type-checking}

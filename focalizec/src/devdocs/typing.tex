% $Id: typing.tex,v 1.6 2009-05-04 11:00:10 pessaux Exp $
...
case of a species expression parameterised used applied to {\tt Self}
...
figure 3.2, section 3.8 in Virgile Prevosto's Phd, the substutition
...
methodes and the parameters). Because these parameters will be
``evaluated'' after the current one, we need to delay the substitution
until they are really processed. Be carreful that by construction,
...
The first one is for the signature {\tt representaton}. Once

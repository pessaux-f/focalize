% $Id: typing.tex,v 1.10 2009-05-12 13:10:19 pessaux Exp $
...
``abstraction'' pass is called before calling the code generation (in
fact, called by each target code generator).

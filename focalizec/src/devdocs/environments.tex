% $Id: environments.tex,v 1.18 2009-05-28 08:43:26 pessaux Exp $
...
\index{value!constructor!scoping env info}
...
\index{record!type!scoping env info}
...
\index{species!scoping env info}
...
\subsubsection{Sum type value constructors}
\index{value!constructor!typing env info}
...
\subsubsection{Record type field names}
\index{record!type!typing env info}
...
\subsubsection{Values}
\index{value!typing env info}
Values are simply bound to their type scheme.

\subsubsection{Types}
\index{type!typing env info}
...
\subsubsection{Sum type value constructors}
\index{value!constructor!\ocaml\ gen env info}
...
\subsubsection{Record type field names}
\index{record!type!\ocaml\ gen env info}
...
\subsubsection{Values}
\index{value!\ocaml\ gen env info}
...
\subsubsection{Sum type value constructors}
\index{value!constructor!\coq\ gen env info}
...
\subsubsection{Record type field names}
\index{record!type!\coq\ gen env info}
Record type field names are handled like in \ocaml.

\subsubsection{Values}
\index{value!\coq\ gen env info}

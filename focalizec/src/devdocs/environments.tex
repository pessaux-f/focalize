% $Id: environments.tex,v 1.4 2009-03-19 08:46:06 pessaux Exp $
...
\medskip
Look-up functions are more complex, especially the one lokking for
...
The principle is to split the looked-up name into a scope specifier (a
...
this environment that we will perform the search. Now, the point is to
check if we are allowed to accept to find a binding induced by an
{\tt open} directive. This is usually the case except if ...........
AH AH AH J'AI TROUVÉ UN BUG DANS LE CODE CAR ÇA NE CORRESPOND À CE QUE
JE PENSE... PAUSE 2 MN, ON CORRIGE LE CODE...

% $Id: codegen_model.tex,v 1.3 2009-03-31 14:11:30 pessaux Exp $
...
\item Next, only in the \ocaml\ code, the record type is always
...
Let's now extend our previous example to illustrate the header of our

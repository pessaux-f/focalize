% $Id: codegen_model.tex,v 1.18 2009-04-21 14:49:32 pessaux Exp $
...
{\footnotesize
\begin{lstlisting}[language=MyOCaml, title=Stub file ml\_stubs.ml]
type ('c, 'd) bbt_record = {
...
{\footnotesize
\begin{lstlisting}[language=MyCoq, title=Stub file coq\_stubs.v]
...
Blabla à propos du fait que le nom (int) est justement bien senti car
dans le compilo, on utilise justement ``int'' comme nom de
constructeur pour inférer le type des expressions entières. Etc...

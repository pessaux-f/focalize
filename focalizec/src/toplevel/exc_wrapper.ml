...
(* $Id: exc_wrapper.ml,v 1.1 2007-08-14 13:20:26 pessaux Exp $ *)
...
| Sys_error m -> Format.fprintf Format.err_formatter "System error - %s.@." m
...
| Env.Unbound_label lname ->
    Format.fprintf Format.err_formatter "Unbound record field label \'%s\'.@."
      lname
...
| Env.Unbound_collection cname ->
    Format.fprintf Format.err_formatter "Unbound collection \'%s\'.@." cname

...
(* | Ph_species : species -> phrase_desc *)
(* | Ph_collection : collection -> phrase_desc *)
(* | Ph_type : type_def -> phrase_desc *)
(* | Ph_let_def : let_def -> phrase_desc *)
(* | Ph_theorem : theorem_def -> phrase_desc *)
(* | Ph_expr : expr -> phrase_desc. *)

Parameter pcm_expr : Set.
Parameter pcm_expr_location : pcm_expr -> option location.
Parameter pcm_expr_is_self : pcm_expr -> bool.
Parameter pcm_expr_is_app : pcm_expr -> bool.
Parameter pcm_expr_app_expr : pcm_expr -> pcm_expr.
Parameter pcm_expr_app_args : pcm_expr -> list pcm_expr.

Parameter pcm_phrase : Set.
Parameter pcm_phrase_location : pcm_phrase -> option location.
Parameter pcm_phrase_is_open : pcm_phrase -> bool.
Parameter pcm_phrase_open_name : pcm_phrase -> string.
Parameter pcm_phrase_is_use : pcm_phrase -> bool.
Parameter pcm_phrase_use_name : pcm_phrase -> string.
Parameter pcm_phrase_is_expr : pcm_phrase -> bool.
Parameter pcm_phrase_expr_value : pcm_phrase -> pcm_expr.

Record pcm_file : Set := pcm_mk_file {
  pcm_file_name : string;
  pcm_file_body : list pcm_phrase
}.

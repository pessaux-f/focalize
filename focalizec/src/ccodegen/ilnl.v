...
Inductive ilnl_expr : Set :=
| ilnl_mk_expr : ast ilnl_expr_desc unit -> ilnl_expr
with ilnl_expr_desc : Set :=
| ilnl_expr_self : ilnl_expr_desc
| ilnl_expr_app : ilnl_expr -> list ilnl_expr -> ilnl_expr_desc.

Inductive ilnl_phrase : Set :=
| ilnl_mk_phrase : ast ilnl_phrase_desc unit -> ilnl_phrase
with ilnl_phrase_desc : Set :=
| ilnl_phrase_open : string -> ilnl_phrase_desc
| ilnl_phrase_use : string -> ilnl_phrase_desc
| ilnl_phrase_expr : ilnl_expr -> ilnl_phrase_desc.

Record ilnl_file : Set := ilnl_mk_file {
  ilnl_file_name : string;
  ilnl_file_body : list ilnl_phrase
}.

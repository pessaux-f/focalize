...
(* $Id: miscHelpers.ml,v 1.6 2009-01-12 15:33:51 pessaux Exp $ *)
...
(** {b Descr} : Because methods parameters do not have their type with them
    in the [species_description]s, this function establish the mapping
    ...
    instanciate the ones generalized in the type scheme. This is useful for
    Coq generation because polymorphism is explicit, leading for each
